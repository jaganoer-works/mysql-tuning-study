...
## 前提・対象者
- **対象**: PHP/Laravel 4年、MySQL 4年、Docker 2年の経験を持つエンジニア
- **期間**: 3ヶ月（週末2-3時間 × 12週）
...
### 目標
- パフォーマンステスト用のMySQL環境構築
- ベンチマークツールの準備
- 監視環境の構築

### 学習内容
- Docker Composeでの複数MySQL環境構築（本番想定）
- Prometheus + Grafana監視環境セットアップ
- 大量テストデータ生成（100万レコード規模）
- sysbench導入とベースライン計測
- phpMyAdmin、Adminer等管理ツール設定

### 週末課題
- 100万レコードのテストデータ生成
- sysbenchでのベースライン計測
- Grafanaダッシュボードでのメトリクス可視化
